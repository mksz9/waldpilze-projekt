...
class gcms_pilzNewsletter_manager
{
    ...
    function __construct()
    {
        ...
        $this->newsletterSender = new gcms_pilzNewsletter_newsletterSender($this->databaseManager);
    ...
    function handleNewsletterHTMLPrintShortCode()
    {
        ...
        if($this->newsletterFormPrinterAndReader->formToSubscribeForNewsletterSent())
        {
            ...
            $this->databaseManager->insertNewEmailAddressForNewsletter($newMailAddressToSubscribe);
